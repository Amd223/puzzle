...
from numpy.ma import zeros, array, ones, mean, std, where, concatenate, vstack
from scipy.ndimage import filters, mean
...
def compute_harris_response(im, sigma=3):
    ...
    :return: image with each pixel containing the value of the Harris response function
    """
...
def get_harris_points(harrisim, min_dist=10, threshold=0.1):
    ...
    :return: all points considered corners
    """
...
img = array(Image.open("images/adam.jpg").convert("L"))
...
img1 = array(Image.open("images/adam.jpg").convert("L"))
img2 = array(Image.open("images/adam.jpg").convert("L"))

wid = 5

harrisim = compute_harris_response(img1)
